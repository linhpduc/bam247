...
class DropdownCountryBox extends StatefulWidget {
  ...
  DropdownCountryBox(this.country, {super.key, this.containerWidth = 200, required this.callBack});
...
class _DropdownCountryBoxState extends State<DropdownCountryBox> {
        ...
        onTap: () {
          setState(() {
            if (isDropdownOpened) {
              ...
              floatingDropdown = _createFloatingDropdown(widget.containerWidth);
  ...
  OverlayEntry _createFloatingDropdown(double width) {
